...
def computeWSMI(file_to_compute, word_to_compute, output_path, sample_rate, channels, samples_per_trial, tau,
                total_time, window_size, window_offset):
